...
- **D21. User advice doctrine** for the README: *export files lose nothing that matters and cost nothing — automation is a convenience upgrade, never a data upgrade* (Garmin excepted until the FIT importer ships). Per-device advice table lives in `docs/connections.md`.
