...
| 2 | Schema 0.3.0: session reference, device window and count, regenerated schema and fixture | ⬜ |
| 3 | Device index: accumulated at import, reported in `ath stats`, first appearances in the import summary | ⬜ |
